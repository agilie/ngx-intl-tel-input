(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('google-libphonenumber'), require('@angular/core'), require('@angular/forms'), require('ngx-bootstrap/utils'), require('ngx-bootstrap/dropdown'), require('@angular/common'), require('ngx-mask')) :
    typeof define === 'function' && define.amd ? define('ngx-intl-tel-input', ['exports', 'google-libphonenumber', '@angular/core', '@angular/forms', 'ngx-bootstrap/utils', 'ngx-bootstrap/dropdown', '@angular/common', 'ngx-mask'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global["ngx-intl-tel-input"] = {}, global["^3"]["2"]["3"], global.ng.core, global.ng.forms, global.utils, global["ngx-bootstrap-dropdown"], global.ng.common, global.ngxMask));
})(this, (function (exports, lpn, core, forms, utils, dropdown, common, ngxMask) { 'use strict';
