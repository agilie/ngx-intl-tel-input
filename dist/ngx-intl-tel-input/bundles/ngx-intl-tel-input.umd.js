(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('@angular/core'),require('@angular/common'),require('ngx-bootstrap/dropdown'),require('ngx-mask'),require('@angular/forms'),exports, require('google-libphonenumber'), require('@angular/core'), require('@angular/forms'), require('ngx-bootstrap/utils'), require('ngx-bootstrap/dropdown'), require('@angular/common'), require('ngx-mask')) :
    typeof define === 'function' && define.amd ? define('ngx-intl-tel-input', ['@angular/core','@angular/common','ngx-bootstrap/dropdown','ngx-mask','@angular/forms','exports', 'google-libphonenumber', '@angular/core', '@angular/forms', 'ngx-bootstrap/utils', 'ngx-bootstrap/dropdown', '@angular/common', 'ngx-mask'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.ng.core,global.ng.common,global.ngxBootstrap.dropdown,global.ngxMask,global.ng.forms,global["ngx-intl-tel-input"] = {}, global["^3"]["2"]["3"], global.ng.core, global.ng.forms, global.utils, global["ngx-bootstrap-dropdown"], global.ng.common, global.ngxMask));
})(this, (function (ɵngcc0,ɵngcc1,ɵngcc2,ɵngcc3,ɵngcc4,exports, lpn, core, forms, utils, dropdown, common, ngxMask) { 
var _c0 = ["countryList"];
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(NativeElementInjectorDirective, [{
    ...
    var ngxMaskModuleForRoot = ngxMask.NgxMaskModule.forRoot();
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(NgxIntlTelInputModule, { declarations: [NgxIntlTelInputComponent, NativeElementInjectorDirective], imports: [ɵngcc1.CommonModule, ɵngcc4.FormsModule, ɵngcc4.ReactiveFormsModule, ɵngcc2.BsDropdownModule, ɵngcc3.NgxMaskModule], exports: [NgxIntlTelInputComponent, NativeElementInjectorDirective] }); })();
